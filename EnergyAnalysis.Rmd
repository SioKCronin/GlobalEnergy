...
# Subset data
df.oil_imports_exports <- subset(df, Product == 'Oil products' & (Flow == 'Imports (ktoe)' | Flow == 'Exports (ktoe)'))

# Melt data
melted_oil_ie <- melt(df.oil_imports_exports, id = c('Country', 'Product', 'Flow'), measured = c('X1971', 'X1972', 'X1973', 'X1974', 'X1975', 'X1976', 'X1977', 'X1978', 'X1979', 'X1980', 'X1981', 'X1982', 'X1983', 'X1984', 'X1985', 'X1986', 'X1987', 'X1988', 'X1989', 'X1990', 'X1991', 'X1992', 'X1993', 'X1994', 'X1995', 'X1996', 'X1997', 'X1998', 'X1999', 'X2000', 'X2001', 'X2002', 'X2003', 'X2004', 'X2007', 'X2008', 'X2009', 'X2010', 'X2011', 'X2012', 'X2013', 'X2014'))
...
df.USA <- subset(df, Country == 'United States' & Flow == 'Imports (ktoe)')

melted_USA <- melt(df.USA, id = c('Country', 'Product', 'Flow'), measured = c('X1971', 'X1972', 'X1973', 'X1974', 'X1975', 'X1976', 'X1977', 'X1978', 'X1979', 'X1980', 'X1981', 'X1982', 'X1983', 'X1984', 'X1985', 'X1986', 'X1987', 'X1988', 'X1989', 'X1990', 'X1991', 'X1992', 'X1993', 'X1994', 'X1995', 'X1996', 'X1997', 'X1998', 'X1999', 'X2000', 'X2001', 'X2002', 'X2003', 'X2004', 'X2007', 'X2008', 'X2009', 'X2010', 'X2011', 'X2012', 'X2013', 'X2014'))
...
melted_USA_import <- subset(melted_USA, Flow == 'Imports (ktoe)' & variable == 'X2014')
...
lbls <- c("Crude,NGL and feedstocks", "Oil products", "Natural gas","Coal, Renewables, and Electricity")
...
ggplot() + 
  geom_line(data = casted_USA, aes(x = Year, y = Electricity, color = "Electricity"), group = 1) +
  geom_line(data = casted_USA, aes(x = Year, y = Nuclear, color = "Nuclear"), group = 1)  +
  geom_line(data = casted_USA, aes(x = Year, y = Oil.products, color = "Oil"), group = 1) +
  geom_line(data = casted_USA, aes(x = Year, y = Coal..peat.and.oil.shale, color = "Coal"), group = 1) +
  geom_line(data = casted_USA, aes(x = Year, y = Natural.gas, color = "Gas"), group = 1) +
  geom_line(data = casted_USA, aes(x = Year, y = Crude.NGL.and.feedstocks, color = "Crude"), group = 1) +
  geom_line(data = casted_USA, aes(x = Year, y = Renewables.and.waste, color = "Renewables"), group = 1) +
  geom_line(data = casted_USA, aes(x = Year, y = Heat, color = "Heat"), group = 1) +
  xlab('Year') +
...
ggplot(df.imports_exports_USA, aes(x = Year)) +
  ...
  geom_line(aes(y = abs(Exports..ktoe.), color = 'Export')) + 
  geom_line(aes(y = Imports..ktoe., color = 'Import')) +      
  scale_x_date(limits = c(as.Date('1971', '%Y'), as.Date('2013', '%Y')), date_breaks = '5 years', date_labels = '%Y') +
  geom_ribbon(data=subset(df.imports_exports_USA, Year < as.Date('2009', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.5") +
  geom_ribbon(data=subset(df.imports_exports_USA, Year >= as.Date('2008', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="blue", alpha="0.5") +
   scale_y_continuous(limits = c(0, 140000), breaks = pretty_breaks(10)) +
  annotate("text", x = as.Date('1980', '%Y'), y = 40000, label = "Net deficit") + 
  scale_y_continuous(limits = c(0, 140000), breaks = pretty_breaks(10)) +
  annotate("text", x = as.Date('2013', '%Y'), y = 100000, label = "Net gain")
...
export<- subset(df.imports_exports_USA$Exports..ktoe., df.imports_exports_USA$Year < as.Date('2014', '%Y') & df.imports_exports_USA$Year > as.Date('2010', '%Y'))
import <- subset(df.imports_exports_USA$Imports..ktoe., df.imports_exports_USA$Year < as.Date('2014', '%Y') & df.imports_exports_USA$Year > as.Date('2010', '%Y')) 
export <- abs(export)
...
ggplot(df.imports_exports_USA, aes(x = Year)) +
  ...
  geom_line(aes(y = abs(Exports..ktoe.), color = 'Export')) + 
  geom_line(aes(y = Imports..ktoe., color = 'Import')) +                     
  scale_x_date(limits = c(as.Date('1995', '%Y'), as.Date('2013', '%Y')), date_breaks = '2 years', date_labels = '%Y') +
  scale_y_continuous(limits = c(0, 140000), breaks = pretty_breaks(10)) +
   geom_ribbon(data=subset(df.imports_exports_USA, Year >= as.Date('2009', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="blue", alpha="0.5") +
  annotate("text", x = as.Date('2012', '%Y'), y = 100000, label = "192203 ktoe") + 
  annotate("text", x = as.Date('2002', '%Y'), y = 60000, label = "Parallel growth") + 
...
export<- subset(df.imports_exports_USA$Exports..ktoe., df.imports_exports_USA$Year < as.Date('2006', '%Y') & df.imports_exports_USA$Year > as.Date('1995', '%Y'))

import <- subset(df.imports_exports_USA$Imports..ktoe., df.imports_exports_USA$Year < as.Date('2006', '%Y') & df.imports_exports_USA$Year > as.Date('1995', '%Y')) 
export <- abs(export)
...
ggplot(df.imports_exports_USA, aes(x = Year)) +
  ...
  geom_line(aes(y = abs(Exports..ktoe.), color = 'Export')) + 
  geom_line(aes(y = Imports..ktoe., color = 'Import')) +  
  geom_ribbon(data=subset(df.imports_exports_USA, Year < as.Date('2009', '%Y') & Year > as.Date('1994', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.5") +        
  scale_x_date(limits = c(as.Date('1994', '%Y'), as.Date('2013', '%Y')), date_breaks = '2 years', date_labels = '%Y') +
  scale_y_continuous(limits = c(0, 140000), breaks = pretty_breaks(10)) +
...
# Subset data
df.ie_crude <- subset(df, Product == 'Crude,NGL and feedstocks' & (Flow == 'Imports (ktoe)' | Flow == 'Exports (ktoe)'))

# Melt data
melted_ie_crude <- melt(df.ie_crude, id = c('Country', 'Product', 'Flow'), measured = c('X1971', 'X1972', 'X1973', 'X1974', 'X1975', 'X1976', 'X1977', 'X1978', 'X1979', 'X1980', 'X1981', 'X1982', 'X1983', 'X1984', 'X1985', 'X1986', 'X1987', 'X1988', 'X1989', 'X1990', 'X1991', 'X1992', 'X1993', 'X1994', 'X1995', 'X1996', 'X1997', 'X1998', 'X1999', 'X2000', 'X2001', 'X2002', 'X2003', 'X2004', 'X2007', 'X2008', 'X2009', 'X2010', 'X2011', 'X2012', 'X2013', 'X2014'))
...
ggplot(df.ie_crude_USA, aes(x = Year)) +
  ...
  geom_line(aes(y = abs(Exports..ktoe.), color = 'Export')) + 
  geom_line(aes(y = Imports..ktoe., color = 'Import')) +                    
  geom_ribbon(data=subset(df.ie_crude_USA, Year > as.Date('1970', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.5") +
   scale_y_continuous(limits = c(0, 620000), breaks = pretty_breaks(10)) +
  annotate("text", x = as.Date('2004', '%Y'), y = 350000, label = "Net deficit")
...
ggplot(df.ie_crude_USA, aes(x = Year)) +
  ...
  geom_line(aes(y = abs(Exports..ktoe.), color = 'Export')) + 
  geom_line(aes(y = Imports..ktoe., color = 'Import')) +                     
  geom_ribbon(data=subset(df.ie_crude_USA, Year > as.Date('1970', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.1") +
   scale_y_continuous(limits = c(0, 620000), breaks = pretty_breaks(10)) +
  geom_line(aes(y = abs(df.imports_exports_USA$Exports..ktoe.), color = 'Export')) + 
  geom_line(aes(y = df.imports_exports_USA$Imports..ktoe., color = 'Import')) +  
  geom_ribbon(data=subset(df.imports_exports_USA, Year < as.Date('2009', '%Y') & Year > as.Date('1970', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.7") +        
  scale_x_date(limits = c(as.Date('1970', '%Y'), as.Date('2013', '%Y')), date_breaks = '5 years', date_labels = '%Y') +
  geom_ribbon(data=subset(df.imports_exports_USA, Year >= as.Date('2009', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="blue", alpha="0.7") + 
  annotate("text", x = as.Date('1993', '%Y'), y = 150000, label = "US oil (foreground) vs. US crude (background)")
```
...
melted_world <- melt(df.world, id = c('Country', 'Product', 'Flow'), measured = c('X1971', 'X1972', 'X1973', 'X1974', 'X1975', 'X1976', 'X1977', 'X1978', 'X1979', 'X1980', 'X1981', 'X1982', 'X1983', 'X1984', 'X1985', 'X1986', 'X1987', 'X1988', 'X1989', 'X1990', 'X1991', 'X1992', 'X1993', 'X1994', 'X1995', 'X1996', 'X1997', 'X1998', 'X1999', 'X2000', 'X2001', 'X2002', 'X2003', 'X2004', 'X2007', 'X2008', 'X2009', 'X2010', 'X2011', 'X2012', 'X2013', 'X2014'))
...
ggplot() + 
  geom_line(data = casted_world, aes(x = Year, y = Electricity, color = "Electricity"), group = 1) +
  geom_line(data = casted_world, aes(x = Year, y = Nuclear, color = "Nuclear"), group = 1)  +
  geom_line(data = casted_world, aes(x = Year, y = Oil.products, color = "Oil"), group = 1) +
  geom_line(data = casted_world, aes(x = Year, y = Coal..peat.and.oil.shale, color = "Coal"), group = 1) +
  geom_line(data = casted_world, aes(x = Year, y = Natural.gas, color = "Gas"), group = 1) +
  geom_line(data = casted_world, aes(x = Year, y = Crude.NGL.and.feedstocks, color = "Crude"), group = 1) +
  geom_line(data = casted_world, aes(x = Year, y = Renewables.and.waste, color = "Renewables"), group = 1) +
  geom_line(data = casted_world, aes(x = Year, y = Heat, color = "Heat"), group = 1) +
  xlab('Year') +
...
netgain <- sum(abs(df.imports_exports_world$Exports..ktoe.) - df.imports_exports_world$Imports..ktoe.)
netgain
```
...
ggplot(df.imports_exports_world, aes(x = Year)) + 
  geom_line(aes(y = abs(Exports..ktoe.)), color = 'red') + 
  geom_line(aes(y = Imports..ktoe.), color = 'blue') +  
  geom_ribbon(data=subset(df.imports_exports_world, Year < as.Date('2015', '%Y') & Year > as.Date('1970', '%Y')),aes(x = Year, ymin=Imports..ktoe., ymax=abs(Exports..ktoe.)), fill="blue", alpha="0.5") +
  scale_x_date(date_breaks = '5 years', date_labels = '%Y') +
  scale_y_continuous(limits = c(0, 1400000), breaks = pretty_breaks(10)) +
  annotate("text", x = as.Date('1989', '%Y'), y = 900000, label = "2586108 ktoe") + 
  ylab("World oil Imports & Exports (ktoe)")
```
...
ggplot(df.imports_exports_w, aes(x = Country, y = Imports..ktoe.)) +
  ...
  scale_y_continuous(limits = c(0, 350000), breaks = pretty_breaks(10), name = "2014 oil imports by region")
...
# Plot pie chart
lbls <- c("Africa", "Middle East", "Non-OECD Americas", "Non-OECD Europe and Eurasia")
pct <- round(slices/sum(slices)*100)
lbls <- paste(lbls, pct) # add percents to labels 
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,labels = lbls, col=rainbow(length(lbls)),
  	main="Percentage of total positive regional net oil flow (1971-2014)")
...
ggplot(df.ie_crude_OECD, aes(x = Year)) +
  ...
  geom_ribbon(data=subset(df.ie_crude_OECD, Year > as.Date('1970', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.5") +
   scale_y_continuous(limits = c(0, 1800000), breaks = pretty_breaks(10)) +
  annotate("text", x = as.Date('2004', '%Y'), y = 1000000, label = "Net deficit")
```

```{r}
# Calculate US percentage of OECD crude net loss
US_crude <- sum(df.ie_crude_USA$Imports..ktoe. - df.ie_crude_USA$Exports..ktoe.)
OECD_crude <- sum(df.ie_crude_OECD$Imports..ktoe. - df.ie_crude_OECD$Exports..ktoe.)
US_crude/OECD_crude
...
ggplot(df.ie_crude_OECD, aes(x = Year)) +
  ...
  geom_ribbon(data=subset(df.ie_crude_OECD, Year > as.Date('1970', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.3") +
   scale_y_continuous(limits = c(0, 1800000), breaks = pretty_breaks(10)) +
  geom_line(aes(y = abs(df.ie_crude_USA$Exports..ktoe.), color = 'Export')) + 
  geom_line(aes(y = df.ie_crude_USA$Imports..ktoe., color = 'Import')) +               
  geom_ribbon(data=subset(df.ie_crude_USA, Year > as.Date('1970', '%Y')), aes(x = Year, ymin=abs(Exports..ktoe.),ymax=Imports..ktoe.), fill="red", alpha="0.75") + 
  annotate("text", x = as.Date('1993', '%Y'), y = 700000, label = "US makes up 24% of OECD total crude net deficit")
```
